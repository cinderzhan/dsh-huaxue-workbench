...
test('v3 system/message preserves historical speakers across metadata-only request headers', () => {
  const events = [
    { type:'system/message', data:{message:{content:'[huaxue:dialogue-v2.4:ning] rules'}} },
    { type:'request/header', data:{header:{config:{},tools:[]}} },
    { type:'assistant/message', data:{id:'first'} },
    { type:'system/message', data:{message:{content:'[huaxue:dialogue-v2.4:qing] rules'}} },
    { type:'request/header', data:{header:{config:{},tools:[]}} },
  ...
  assert.deepEqual(messageAttributions(events), {
    first:{memberId:'ning',version:'dialogue-v2.4'},
    second:{memberId:'qing',version:'dialogue-v2.4'},
  });
});
